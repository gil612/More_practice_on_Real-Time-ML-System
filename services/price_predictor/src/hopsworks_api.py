...
def push_value_to_feature_group(
    ...
    feature_group = feature_store.get_or_create_feature_group(
        ...
        stream=False,  # Disable streaming/Kafka transport
        statistics_config=False,  # Disable statistics computation for faster inserts
        description="OHLCV data from Kraken exchange",
        time_travel_format="HUDI",  # Use HUDI for better time travel capabilities
    ...
    # push the value to the Feature Store using batch insert
    feature_group.insert(
        value_df,
        write_options={
            "start_offline_materialization": start_offline_materialization,
            "wait_for_job": True,  # Wait for the insert to complete
            "validation": False,  # Disable validation for faster inserts
